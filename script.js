(() => {
  const LEAD_ENDPOINT = 'https://lead-relay.leestygpt.workers.dev/lead/GPDG9H3E9M';
  ...
  const targets = document.querySelectorAll(
    '.card, .price-card, .tl-step, .isni-badge, .quote-block, .faq__item, .form-section, .hero__card'
  );
